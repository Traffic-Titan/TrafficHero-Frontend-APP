...
List<Map<String, String>> city = [
  ...
  {'value': 'Keelung_City', 'title': '基隆市', 'body': '2. 北部區域'},
  {'value': 'New_Taipei_City', 'title': '新北市', 'body': '2. 北部區域'},
  {'value': 'Taipei_City', 'title': '臺北市', 'body': '2. 北部區域'},
  {'value': 'Hsinchu_City', 'title': '新竹市', 'body': '2. 北部區域'},
  {'value': 'Taoyuan_City', 'title': '桃園市', 'body': '2. 北部區域'},
  {'value': 'Hsinchu_County', 'title': '新竹縣', 'body': '2. 北部區域'},
  {'value': 'Yilan_County', 'title': '宜蘭縣', 'body': '2. 北部區域'},
  {'value': 'Taichung_City', 'title': '臺中市', 'body': '3. 中部區域'},
  {'value': 'Miaoli_County', 'title': '苗栗縣', 'body': '3. 中部區域'},
  {'value': 'Changhua_County', 'title': '彰化縣', 'body': '3. 中部區域'},
  {'value': 'Nantou_County', 'title': '南投縣', 'body': '3. 中部區域'},
  {'value': 'Yunlin_County', 'title': '雲林縣', 'body': '3. 中部區域'},
  {'value': 'Kaohsiung_City', 'title': '高雄市', 'body': '4. 南部區域'},
  {'value': 'Tainan_City', 'title': '臺南市', 'body': '4. 南部區域'},
  {'value': 'Chiayi_City', 'title': '嘉義市', 'body': '4. 南部區域'},
  {'value': 'Chiayi_County', 'title': '嘉義縣', 'body': '4. 南部區域'},
  {'value': 'Pingtung_County', 'title': '屏東縣', 'body': '4. 南部區域'},
  {'value': 'Hualien_County', 'title': '花蓮縣', 'body': '5. 東部區域'},
  {'value': 'Taitung_County', 'title': '臺東縣', 'body': '5. 東部區域'},
  {'value': 'Penghu_County', 'title': '澎湖縣', 'body': '6. 離島區域'},
  {'value': 'Kinmen_County', 'title': '金門縣', 'body': '6. 離島區域'},
  {'value': 'Lienchiang_County', 'title': '連江縣', 'body': '6. 離島區域'},
];
