...
//主程式
class MassTransitMode extends StatefulWidget {
  const MassTransitMode({super.key});

  @override
  State<MassTransitMode> createState() => _MassTransitMode();
}

class _MassTransitMode extends State<MassTransitMode> {
