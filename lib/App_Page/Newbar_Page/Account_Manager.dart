    ...
    return Scaffold(
      ...
      body: Scrollbar(
        child: Column(
          children: [
            Center(
              child: Image.memory(img,height: 90,),
            ),
            const Align(alignment: Alignment.topLeft,child: Text("  個人資訊",style: TextStyle(fontSize: 23,color: Color.fromRGBO(46, 117, 182, 1))),),
            Container(
                ...
                children: [
                  Expanded(
                    ...
                    child: Row(
                      children: [
                        Expanded(flex:1,
                            child: Align(alignment: Alignment.center,child: Text("姓名",style: TextStyle(fontSize: 18,color: Color.fromRGBO(24, 60, 126, 1))))),
                        Expanded(flex:2,
                          child: TextField(
                        ...
                        Expanded(flex:1,
                            child: Align(alignment: Alignment.center,child: Text("生日",style: TextStyle(fontSize: 18,color: Color.fromRGBO(24, 60, 126, 1))))),
                        Expanded(flex:4,
                          child: TextField(
                  ...
                  Expanded(
                    ...
                    child: Row(
                      children: [
                        Expanded(flex:1,
                            child: Align(alignment: Alignment.center,child: Text("性別",style: TextStyle(fontSize: 18,color: Color.fromRGBO(24, 60, 126, 1))))),
                        Expanded(flex:2,
                          child: TextField(
                        ...
                        Expanded(flex:1,
                            child: Align(alignment: Alignment.center,child: Text("手機",style: TextStyle(fontSize: 18,color: Color.fromRGBO(24, 60, 126, 1))))),
                        Expanded(flex:4,
                          child: TextField(
                            decoration: InputDecoration(
                              border: OutlineInputBorder(),
            ...
            const Align(alignment: Alignment.topLeft,child: Text("  帳號管理",style: TextStyle(fontSize: 23,color: Color.fromRGBO(46, 117, 182, 1))),),
            Container(
              margin: EdgeInsets.only(left: 15,right: 15,top: 5),
              padding: EdgeInsets.all(10),
              height: 150,
                ...
                children: [
                  Expanded(
                    ...
                    child: Row(
                      children: [
                        Expanded(flex:1,
                            child: Align(alignment: Alignment.center,child: Text("帳號",style: TextStyle(fontSize: 18,color: Color.fromRGBO(24, 60, 126, 1))))),
                        Expanded(flex:4,
                          child: TextField(
                            decoration: InputDecoration(
                              border: OutlineInputBorder(),
                  ...
                  Expanded(
                    ...
                    child: Row(
                      children: [
                        Expanded(flex:1,
                            child: Align(alignment: Alignment.center,child: Text("密碼",style: TextStyle(fontSize: 18,color: Color.fromRGBO(24, 60, 126, 1))))),
                        Expanded(flex:4,
                          child: TextField(
                            decoration: InputDecoration(
                              border: OutlineInputBorder(),
