...
class TRA_TimeTableSearch_ByStation_OutBound extends StatefulWidget {
  ...
  @override
  State<TRA_TimeTableSearch_ByStation_OutBound> createState() =>
      _TRA_TimeTableSearch_ByStation_OutBoundState();
}

class _TRA_TimeTableSearch_ByStation_OutBoundState
    extends State<TRA_TimeTableSearch_ByStation_OutBound> {
  var screenWidth;
  var StationName;
