    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Divider(height: 2,color: Color.fromRGBO(24, 60, 126, 1),),
          // 內容
          Flexible(
                    ...
                    children: [
                      Row(
                        children: [
                              ...
                              child: ListTile(
                                title: SizedBox(
                                    ...
                                    child: DecoratedBox(
                                      ...
                                      child: Text(list['車號'],style: const TextStyle(color: Colors.white,fontSize: 20),textAlign: TextAlign.center,),
                                    )
                                ),
                                subtitle: const Text("自由座車廂：6、7 車廂",style: TextStyle(fontSize: 10)),
                              ),
                              onTap: () async{
                          ...
                          Expanded(
                            flex: 3,
                            child: Text(list['出發時間'],style: const TextStyle(fontSize: 20),textAlign: TextAlign.center,),
                          ),
                          const Expanded(
                              flex: 2,
                          ...
                          Expanded(
                            flex: 3,
                            child: Text(list['抵達時間'],style: const TextStyle(fontSize: 20),textAlign: TextAlign.center,),
                          ),
                        ],
                      ),
                      (THSRDetail.length==index) ? const Text('') : const Divider(height: 2,color: Color.fromRGBO(24, 60, 126, 1),),
                    ],
                  );
                }
            ),
