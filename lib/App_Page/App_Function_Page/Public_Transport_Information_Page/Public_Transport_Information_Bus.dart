                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      leading:Container(
                        ...
                        })(),style: const TextStyle(fontSize: 23),textAlign: TextAlign.center,),
                      ),
                      title: Column(
                          children:[
                  ...
                  children: [
                    Container(
                      ...
                      child: ElevatedButton(
                          style: ButtonStyle(
                            backgroundColor: MaterialStateProperty.all(const Color.fromRGBO(165, 201, 233, 1)),
                            side: MaterialStateProperty.all(const BorderSide(color: Color.fromRGBO(29, 73, 153, 1),width: 4)),
                            minimumSize: MaterialStateProperty.all(Size(screenWidth - 30 > 600 ? 600 : screenWidth - 30, 50)),
                          ),
                          onPressed: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => const BusRouteSearch()));
                          },
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: (){
                            //站點地圖
                            Navigator.push(context, MaterialPageRoute(builder: (context) => const StationMap_Bus()));
                          },
                          child: const ListTile(
