...
class _TRA_TimeTableSearch_CarNumSearchState extends State<TRA_TimeTableSearch_CarNumSearch> {
  ...
  Widget build(BuildContext context) {
    ...
    getStationTimeTableByNum() async{
      var url = '${dotenv.env['TRA_DailyTimeTable_ByCarNum']}?CarNum=${carNum}&TrainDate=${dateTime_date}';
      ...
      if (response.statusCode == 200) {
        ...
        Future.delayed(const Duration(seconds: 1),(){
          Navigator.push(context, MaterialPageRoute(builder: (context) => const TRA_TimeTableSearch_CarNum_Result()));
        });
      }
    }
    return Scaffold(
