...
class THSR_StartEndStationSearch extends StatefulWidget {
  ...
  @override
  State<THSR_StartEndStationSearch> createState() =>
      _THSR_StartEndStationSearchState();
}
...
class _THSR_StartEndStationSearchState
    extends State<THSR_StartEndStationSearch> {
  @override
  Widget build(BuildContext context) {
    ...
    getStationList() async {
      var url =
          '${dotenv.env['THSR_SearchBy_Date_Stop']}?OriginStationName=${dropDownValue_Start}&DestinationStationName=${dropDownValue_End}&TrainDate=${selectedDate}';
      ...
      if (response.statusCode == 200) {
        setState(() {
          ...
          state.updateTHSR_StartEndSearchResult(
        ...
        Future.delayed(Duration(seconds: 1), () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => THSR_StartEndStationSearch_Result()));
        });
      }
    }
            ...
            child: Row(
              ...
              children: [
                ...
                DecoratedBox(
                    decoration: BoxDecoration(
                        border: Border.all(
                            color: Color.fromRGBO(24, 60, 126, 1), width: 2),
